  ...
  <div class="container">
    <div class="row g-5">
      <div class="col-lg-4">
        ...
        <div style="margin-top:24px;display:flex;gap:10px;flex-wrap:wrap;">
          <div style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);border-radius:8px;padding:10px 14px;text-align:center;">
            <div style="color:var(--gold);font-size:.72rem;font-weight:700;letter-spacing:1px;">ISO 9001</div>
      ...
      <div class="col-md-6 col-lg-4">
        ...
        <p style="color:rgba(255,255,255,.4);font-size:.85rem;line-height:1.7;margin-bottom:16px;">Monthly bookkeeping tips, HMRC updates, and exclusive offers for London businesses.</p>
